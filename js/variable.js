...
var viewProduct = '<li><a class="has-no-arrow  " href="manage-product.html" aria-expanded="false"><i class="fa fa-eye"></i><span class="hide-menu" >View Products</span></a></li>';
...
var shopRecord = '<div class="col-md-12"><div class="card"><div class="card-table"><div class="card-title shopManagerRecord"><div class="col-lg-3"><div class="form-group"><label for="sel1">Product:</label><select class="form-control" id="productfilter"><option>All</option></select></div></div><div class="col-lg-3"><div class="form-group"><label for="sel1">Type:</label><select class="form-control" id="typefilter"><option>Both</option><option>IN</option><option>OUT</option></select></div></div><div class="col-lg-4"><div class="form-group"><label for="usr">Filter :</label><input type="text" class="form-control" id="filter" name="daterange" value="01/01/2018 - 01/15/2018" /></div></div><div class="col-lg-2"><br><button class="btn btn-warning" type="button" onclick="resetFilter(0);">Reset</button></div></div><div class="card-body"><div class="table-responsive"><table class="table"><thead id="record-head-val"><tr><th>#</th><th>Date</th><th>Code</th><th>Price</th><th class="IN">IN</th><th class="OUT">OUT</th><th>Balance</th><th>Income</th></tr></thead><tbody id="record-val"></tbody></table></div></div></div></div></div>';
...
function composeShop(id){
    ...
    + id +'">0</h2></div></div><hr><div class="card-body"><div class="col-lg-12 card-body-section"><div class="card-table"><div class="card-title"><div class="col-lg-3"><div class="form-group"><label for="sel1">Product:</label><select class="form-control" id="productfilter-'+id+'"><option>All</option></select></div></div><div class="col-lg-3"><div class="form-group"><label for="sel1">Type:</label><select class="form-control" id="typefilter-'+id+'"><option>Both</option><option>IN</option><option>OUT</option></select></div></div><div class="col-lg-4"><div class="form-group"><label for="usr">Filter :</label><input type="text" class="form-control" id="filter-'+id+'" name="daterange-'+id+'" value="01/01/2018 - 01/15/2018" /></div></div><div class="col-lg-2"><br><button class="btn btn-warning" type="button" onclick="resetFilter('+id+');">Reset</button></div></div><div class="card-body"><div class="table-responsive"><table class="table"><thead id="record-head-val-'+id+'"><tr><th>#</th><th>Date</th><th>Code</th><th>Price</th><th class="IN">IN</th><th class="OUT">OUT</th><th>Balance</th><th>Income</th></tr></thead><tbody id="record-val-'
