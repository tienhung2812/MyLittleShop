...
var shopRecord = '<div class="col-md-12"><div class="card"><div class="card-table"><div class="card-title shopManagerRecord"><div class="col-lg-6"><div class="form-group"><label for="sel1">Product:</label><select class="form-control" id="productfilter"><option>All</option></select></div></div><div class="col-lg-6"><div class="form-group"><label for="usr">Filter :</label><input type="text" class="form-control" id="filter" name="daterange" value="01/01/2018 - 01/15/2018" /></div></div></div><div class="card-body"><div class="table-responsive"><table class="table"><thead><tr><th>#</th><th>Date</th><th>Code</th><th>Price</th><th>IN</th><th>OUT</th><th>Balance</th><th>Income</th></tr></thead><tbody id="record-val"></tbody></table></div></div></div></div></div>';
...
function composeShop(id){
    ...
    + id +'">0</h2></div></div><hr><div class="card-body"><div class="col-lg-12 card-body-section"><div class="card-table"><div class="card-title"><div class="col-lg-6"><div class="form-group"><label for="sel1">Product:</label><select class="form-control" id="productfilter-'+id+'"><option>All</option></select></div></div><div class="col-lg-6"><div class="form-group"><label for="usr">Filter :</label><input type="text" class="form-control" id="filter-'+id+'" name="daterange-'+id+'" value="01/01/2018 - 01/15/2018" /></div></div></div><div class="card-body"><div class="table-responsive"><table class="table"><thead><tr><th>#</th><th>Date</th><th>Code</th><th>Price</th><th>IN</th><th>OUT</th><th>Balance</th><th>Income</th></tr></thead><tbody id="record-val-'
